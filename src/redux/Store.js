                ...
                'text': [
                    {
                        'text': <p>На подготовленной спланированной площадке установить деревянные подкладки на ширину
                            ...
                            Опорные поверхности рам лесов должны находиться строго в одной горизонтальной плоскости.
                        </p>
                    },
                    {
                        'text': <p>В башмаки установить две смежные рамы первого яруса, и соединить их горизонтальными и
                                диагональными связями. <br/><br/>
                                Через шаг установить две смежные рамы и также соединить их связями и повторить эту
                                операцию для
                                набора необходимой длины лесов.</p>
                    },
                    {
                        'text': <p>Установить рамы второго яруса, соединить их связями, причем диагональные связи
                                расположить со стороны улицы таким образом, чтобы они были установлены в шахматном
                                порядке,
                                горизонтальные связи устанавливаются со стороны здания. <br/><br/>
                                Для монтажа допускается использовать ригели, на которые укладываются деревянные
                                монтажные щиты
                                настила.</p>
                    },
                    {
                    ...
                    },
                    {
                        'text': <p>Повторяя этапы 3, 4 набрать необходимую высоту лесов. <br/>
                                Ограждения, промежуточные элементы и диагонали должны быть установлены в соответствии с
                                общей
                    ...
                    },
                    {
                        'text': <p>На рабочем и страховочном ярусах лесов установить торцевые и продольные связи
                                ограждений. <br/><br/>
                                В местах подъёма рабочих на рабочий ярус, где не установлены диагональные связи,
                                установить
