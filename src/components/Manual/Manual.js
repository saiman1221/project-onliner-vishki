    ...
    return (
        <div className={'Manual__manual container'}>
            ...
            <div className={'Manual__cards'}>
                ...
                <div className={'Manual__card'}>
                    <p className={'Manual__number'}>02</p>
                    <div className={'Manual__text'}>
                ...
                <div className={'Manual__card'}>
                    <p className={'Manual__number'}>03</p>
                    <div className={'Manual__text'}>
                ...
                <div className={'Manual__card'}>
                    <p className={'Manual__number'}>04</p>
                    <div className={'Manual__text'}>
                ...
                <div className={'Manual__card'}>
                    <p className={'Manual__number'}>05</p>
                    <div className={'Manual__text'}>
